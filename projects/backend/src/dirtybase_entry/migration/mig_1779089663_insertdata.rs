...
impl Migration for Mig1779089663InsertData {
    ...
    async fn down(&self, _manager: &Manager, _ctx: &Context) -> Result<(), anyhow::Error> {
        // Nothing to do
        Ok(())
    }
}
...
[
  ...
  {"name":"Congo (Republic of the)","alpha2":"CG","alpha3":"COG"},
  ...
  {"name":"England","alpha2":"GB-ENG","alpha3":"ENG"},
  {"name":"Scotland","alpha2":"GB-SCT","alpha3":"SCT"},
  {"name":"Wales","alpha2":"GB-WLS","alpha3":"WLS"},
  {"name":"Northern Ireland","alpha2":"GB-NIR","alpha3":"NIR"},
