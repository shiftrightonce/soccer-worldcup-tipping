<template>
  <SelectCountries :tipStrategy="props.tipStrategy" :max="16" :countries="countries" :is-closed="props.isClosed"
    label="Select 16 countries" v-model="model"></SelectCountries>
</template>
